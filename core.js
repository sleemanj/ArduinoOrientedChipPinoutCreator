...
Element.implement({
	...
	getOffsetParent: brokenOffsetParent ? function(){
		...
		while ((element = element.parentNode)){
			if (isOffsetCheck(element) && element.tagName) return element;
		}
		return null;
	} : function(){
		var element = this;
		...
		try {
			return (element.offsetParent && element.offsetParent.tagName) ? element.offsetParent : null;
		} catch(e) {}
		return null;
	},
...
Fx.CSS = new Class({
	...
	render: function(element, property, value, unit){
		document.id(element).setStyle(property, this.serve(value, unit));
	},
